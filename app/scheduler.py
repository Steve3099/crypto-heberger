...
scheduler.add_job(six_minute_chrone_task, "interval", minutes=600, coalesce=True, misfire_grace_time=300, kwargs={}, id="crypto_price_update", replace_existing=True)
