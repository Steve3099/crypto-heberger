...
scheduler.add_job(coinGeckoService.schedule_historique_prix, "cron", hour=11, minute=45)
scheduler.add_job(coinGeckoService.schedule_market_cap, "cron", hour=12, minute=16)
